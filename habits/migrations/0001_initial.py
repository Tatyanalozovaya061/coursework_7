    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField(blank=True, null=True, verbose_name='Время начала выполнения')),
                ...
                ('duration_time', models.TimeField(blank=True, null=True, verbose_name='Длительность выполнения')),
